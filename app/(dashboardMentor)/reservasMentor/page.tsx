...
export default function ReservasMentorPage() {
  ...
  async function loadMentorships() {
    try {
      ...
      if (!response.ok) {
        ...
        setError(
          data.error ||
            "No se pudieron cargar tus mentorías.",
        );
  ...
  async function confirmMentorship(
    ...
    <div className="page-content">
      <section className="welcome-row">
        <div>
          ...
          <p className="intro">
            Consulta las sesiones que
            tienes asignadas y confirma
            tu participación.
          </p>
        </div>
      </section>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>
            Cuando tengas una sesión
            programada aparecerá aquí.
          </p>
        </div>
      ) : (
